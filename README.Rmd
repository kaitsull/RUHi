...
Raw files used for this analysis are directly from FIJI Quantification and can be found in [this repo](https://github.com/kaitsull/RUHi/tree/master/data).  
...
mydata <- ruRead("~/RUHi/data", region = "intermediate", anum = "123456", section = "1")
